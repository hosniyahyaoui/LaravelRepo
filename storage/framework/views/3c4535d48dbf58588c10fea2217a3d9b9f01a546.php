        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form method="POST" action="<?php echo e(route('user/add/save')); ?>" class="md-float-material" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="image" type="file" id="image" multiple="">
                            <div class="form-control-icon">
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Enter Your Phone Number">
                            <div class="form-control-icon">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\wassy\laravel_dashboard_version13\resources\views/usermanagement/add_new_user.blade.php ENDPATH**/ ?>