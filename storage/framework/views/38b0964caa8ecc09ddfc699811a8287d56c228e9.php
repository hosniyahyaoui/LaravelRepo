...
<div id="main">
    ...
    <div class="col-12">
      ...
      <?php endif; ?>
                    <form class="form form-horizontal" action="<?php echo e(route('locaux.store')); ?>"  method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-body">
                            <div class="row">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('titre')); ?>"
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('description')); ?>"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="date" class="form-control <?php $__errorArgs = ['dateCreation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dateCreation')); ?>"
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('capacite')); ?>"
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('adresse')); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hosni\Desktop\laravel_project\laravel_dashboard_version13\resources\views/locaux/create.blade.php ENDPATH**/ ?>