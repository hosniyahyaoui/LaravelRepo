...
unset($__errorArgs, $__bag); ?>
                        ...
                        <a href="<?php echo e(route('facebook.login')); ?>" class="btn btn-facebook btn-user btn-block">
                         ...
                         <hr>
                         <a href="<?php echo e(route('twitter')); ?>" class="btn btn-twitter btn-user btn-block">
                         ...
                         <hr>
                         <a href="<?php echo e(route('github.login')); ?>" class="btn btn-github btn-user btn-block">
                         ...
                         <hr>
                         <a href="<?php echo e(route('linkedin.login')); ?>" class="btn btn-linkedin btn-user btn-block">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Don't have an account? <a href="<?php echo e(route('register')); ?>"
                                class="font-bold">Sign
                                up</a>.</p>
                        <p><a class="font-bold" href="<?php echo e(route('forget-password')); ?>">Forgot password?</a>.</p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hosni\Desktop\laravel_project\laravel_dashboard_version13\resources\views/auth/login.blade.php ENDPATH**/ ?>