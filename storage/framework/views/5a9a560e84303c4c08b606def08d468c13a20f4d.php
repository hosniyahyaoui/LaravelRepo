                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($activity_logs); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($user_activity_logs); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h6 class="font-extrabold mb-0"><?php echo e($staff); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body py-4 px-5">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl">
                                <img src="<?php echo e(URL::to('/images/'. Auth::user()->avatar)); ?>" alt="<?php echo e(Auth::user()->avatar); ?>">
                            </div>
                            <div class="ms-3 name">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" name="fullName" value="<?php echo e(Auth::user()->name); ?>" readonly>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="number" class="form-control" value="<?php echo e(Auth::user()->phone_number); ?>" readonly>
                                                        <div class="form-control-icon">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" value="<?php echo e(Auth::user()->status); ?>" readonly>
                                                        <div class="form-control-icon">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group has-icon-left">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" value="<?php echo e(Auth::user()->role_name); ?>" readonly>
                                                        <div class="form-control-icon">
    ...
    <footer>
        <div class="footer clearfix mb-0 text-muted">
            ...
            <div class="float-end">
                ...
                href="https://www.facebook.com/wassim.jaffel.58">wassym jaffel</a></p>
            </div>
        </div>
    </footer>
</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hosni\Desktop\laravel_project\laravel_dashboard_version13\resources\views/home.blade.php ENDPATH**/ ?>