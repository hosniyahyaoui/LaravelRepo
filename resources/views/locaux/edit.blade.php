...
<div id="main">
    ...
    <div class="col-12">
      ...
      @endif
                    <form class="form form-horizontal" action="/admin/locaux/update/{{$value->id}}" method="POST">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('titre') is-invalid @enderror" value="{{$value->titre}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="date" class="form-control @error('dateCreation') is-invalid @enderror" value="{{$value->dateCreation}}"
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="occupation" value="{{$value->occupation}}" id="male">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('adresse') is-invalid @enderror" value="{{$value->adresse}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" class="form-control @error('capacite') is-invalid @enderror" value="{{$value->capacite}}"
