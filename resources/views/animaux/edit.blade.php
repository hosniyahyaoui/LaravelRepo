...
<div id="main">
    ...
    <div class="col-12">
      ...
      @endif
                    <form class="form form-horizontal" action="/admin/animaux/update/{{$value->id}}" method="POST">
                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('nom') is-invalid @enderror"  value="{{$value->nom}}" 
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('description') is-invalid @enderror" value="{{$value->description}}" 
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="date" class="form-control @error('datedeNaissance') is-invalid @enderror"  value="{{$value->datedeNaissance}}" 
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="date" class="form-control @error('datedubutTraitement') is-invalid @enderror" value="{{$value->datedubutTraitement}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('type_maladie') is-invalid @enderror" value="{{$value->type_maladie}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" class="form-control @error('dureeTraitement') is-invalid @enderror" value="{{$value->dureeTraitement}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('prixTraitement') is-invalid @enderror" value="{{$value->prixTraitement}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" class="form-control @error('age') is-invalid @enderror"  value="{{$value->age}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('poid') is-invalid @enderror" value="{{$value->poid}}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control @error('espece') is-invalid @enderror" value="{{$value->espece}}"
