...
Route::post('association/add',[\App\Http\Controllers\AssociationController::class, 'add']);
Route::get('association/add2',[\App\Http\Controllers\AssociationController::class, 'add2']);
...
Route::get('associations/list',function ($list){

    return view('/associationManagement/listassociations');
});
Route::get('associations/form_add',function (){
    return view('/associationManagement/addassociations');
})->name(('associations/form_add'));;
Route::get('associations/form_update/{id}',function (Request $request,$key){
    return view('/associationManagement/updateassociations',['i'=>$key]);
})->name(('association/form_update/{id}'));
Route::post('association/add',[\App\Http\Controllers\AssociationController::class, 'add'])->name(('associations/add'));
Route::get('association/get',[\App\Http\Controllers\AssociationController::class,'list'])->name(('association/get'));
Route::get('association/delete/{id}',[\App\Http\Controllers\AssociationController::class,'delete'])->name(('association/delete/{id}'));
Route::post('association/update/{id}',[\App\Http\Controllers\AssociationController::class,'update'])->name(('association/update/{id}'));
Route::get('volunteer/register_form',function (){
    return view('/volunteersManagement/register_volunteer');
});
Route::get('volunteer/login_form',function (){
    return view('/volunteersManagement/login_volunteer');
})->name(('volunteer/login_volunteer'));
Route::get('volunteer/choose',function ($list,$id ){
    return view('/volunteersManagement/chooseAssociations');
})->name(('volunteer/chooseAssociations'));

Route::get('volunteer/login',[\App\Http\Controllers\VolunteerController::class,'login'])->name(('volunteer/login'));
Route::post('volunteer/register',[\App\Http\Controllers\VolunteerController::class,'register'])->name(('volunteer/register'));
Route::get('volunteer/join/{id}/{i}',[\App\Http\Controllers\VolunteerController::class,'choose'])->name(('volunteer/join/{id}/{i}'));
...
//Route::get('/search','App\Http\Controllers\VaccinController@search')->name('vaccins.search');
...
//locaux
Route::resource('locaux',App\Http\Controllers\LocauxController::class);
//Animaux
Route::resource('animaux',App\Http\Controllers\AnimauxController::class);
